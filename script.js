...
const data = [
    ...
    },    
    {
        ...
        about: "Rameshwaram owns the 7th position among the sequence of 12 jyotirlingas. The temple has a magnificent Dravidian style of architecture. Rameshwaram temple is located in a small town, which is situated in Pamban Island in Tamil Nadu. The special thing about the Rameshwaram temple is that there are twenty-two water bodies present in the temple complex."
    },    {
        img: "Nageshwar.jpg",
        heading: "Nageshwar Jyotirlinga",
        about: "On the coast of Saurashtra in Gujarat, between Gomati Dwarka and Bet Dwarka. Nageshwar is one of the most famous Jyotirlinga temples in India as it signifies the power of protection from all types of poisons. The temple is built with pink stone and the idol is Dakshinamurti. Only Hindu devotees are allowed to visit inside the Sanctorum to worship or perform Abhishek."
    },    
    {
